...
const Admin = {
  ...
  OrderManage: lazy(() => import("@/features/admin/AdminPages").then((m) => ({ default: m.AdminOrderManagePage }))),
            ...
            children: [
              {
                ...
                children: [
                  ...
                  { path: "orders/:orderNumber", element: <Suspense fallback={<PageLoader />}><Admin.OrderManage /></Suspense> },
